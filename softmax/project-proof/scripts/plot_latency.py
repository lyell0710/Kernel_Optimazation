...
FIG_PATH = ROOT / "project-proof" / "docs" / "figures" / "01-benchmark" / "01-latency.png"
...
for bar, value in zip(bars, latency):
    plt.text(bar.get_x() + bar.get_width() / 2, value, f"{value:.6f} ms", ha="center", va="bottom", fontsize=8)

plt.title("CUDA Softmax Latency Comparison")
plt.xlabel("Version")
