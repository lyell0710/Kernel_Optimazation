...
VERSION_ORDER = ["baseline"] + [f"v{i}" for i in range(16)]
...
def main() -> None:
    ...
    ax.set_title("NCU Throughput Summary")
    ...
    # Figure 2: occupancy + instruction
    ...
    ax1.set_title("NCU Occupancy and Instruction Summary")
    fig.tight_layout()
    fig.savefig(FIG_DIR / "02-ncu-occupancy-inst.png", dpi=220)
    plt.close(fig)

    # Figure 3: bound classification scatter
    ...
    ax.set_title("NCU Bound Classification (Heuristic)")
