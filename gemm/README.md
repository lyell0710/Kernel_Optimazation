...
对标真 cuBLAS(`cublasGemmEx`,调用点验真)的手写版本梯,完整记录见
[../records/EXP-K02_cuda_gemm_tc_ladder.md](../records/EXP-K02_cuda_gemm_tc_ladder.md)。
...
一句话读法:fp16 GEMM 的性能台阶是指令世代(v1→v2 ×13.8),不是访存微调
(v0→v1 仅 +25%);v4 理论 occupancy 33% 全梯最低却最快(ILP > 线程数)。
